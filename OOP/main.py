...
from child import Child, searchWindow
...
class Main(tk.Frame):
    ...
    def init_main(self):
        ...
        self.add_img2 = tk.PhotoImage(file="BD/search.gif")
        btn_search_dialog = tk.Button(toolbar, text='Найти игрока', command=self.open_search, bg='#5da130', bd=0,
                                    compound=tk.TOP, image=self.add_img2)
        btn_search_dialog.pack(side=tk.LEFT, padx=5)
